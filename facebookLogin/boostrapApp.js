"use strict";
define(['angularAMD','angular-route','blockUI',"angular-sanitize", 'ezfb', 'facebook'], function (angularAMD) {	
	var app = angular.module("mainModule", ['ngRoute','blockUI',"ngSanitize", 'ezfb', 'facebook']);	
	...
	app.config(function (ezfbProvider) {
	  ezfbProvider.setInitParams({
		appId: '729127193823721'
	  });  
	});
	*/	
	
	app.config(['FacebookProvider', function(FacebookProvider) {
		var myAppId = '729127193823721';
		...
		*/
		...
		console.log('myAppId ' + FacebookProvider.getAppId());
