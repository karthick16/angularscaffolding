...
exports.createRoutes = function (app) {
	...
	app.post('/upload', function(req, res) {
		...
		form.parse(req, function(err, fields, files) {
	            ...
	            fs.readFile(files.file.path, function(err, data) {	            	
	            	...
	            	var newPath = path.join(__dirname, "../webapp/uploads/post", filenameModified);
	...
	function resizeImage(filenameModified,callback){
		im.resize({
		    srcData : fs.readFileSync('webapp/uploads/post/' + filenameModified, 'binary'),
		    strip : false,
		    width : 1555,
		    height : "1037^",
		    customArgs: [ 
		  ...
		  if (err) throw err
		  fs.writeFileSync('webapp/uploads/post/aspectratio/' + filenameModified, stdout, 'binary');
